...
WalkingTheWorld.o: builddir
	clang++ -std=c++20 -O0 -g -Iinclude -Ideps/glade/include -I${DEPS_PATH}/glew/include -DGLADE_MACOS -c src/states/WalkingTheWorld.cpp -o build/strug/WalkingTheWorld.o
