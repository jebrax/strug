...
strug: main-glfw.o ResourceManager.o Frank.o Cube.o Sphere.o Isosurface.o MarchingCubes.o Chunked.o CubeTest.o Craft.o sha1.o builddir
...
Craft.o: builddir
	clang++ -std=c++20 -O0 -g -I../../vendor/libccd/src -I../../vendor/PerlinNoise/include -I../../vendor/eigen -I../../vendor/fcl/include -I../../vendor/fcl/build/include -I../../vendor/glew/include -I include -I ../glade/include -DGLADE_MACOS -c src/states/Craft.cpp -o build/strug/Craft.o
